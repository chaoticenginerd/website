+++
title = "Dummy Post: Styleguide"
description = "A markdown styleguide for reference. Based on Poor Man's Styleguide."
date = 2021-06-01
+++

WIP. A markdown styleguide for reference. Based on [Poor Man's Styleguide](https://poormansstyleguide.com/).
...
def factorial(n: Int): BigInt =
  @tailrec
  def fact(n: Int, accumulator: BigInt) =
    if n <= 1 then n
